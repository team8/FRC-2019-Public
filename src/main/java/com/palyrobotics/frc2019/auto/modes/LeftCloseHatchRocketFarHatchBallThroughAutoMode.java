...
public class LeftCloseHatchRocketFarHatchBallThroughAutoMode extends AutoModeBase {
	...
	public Routine getRoutine() {
		return new SequentialRoutine(new LeftStartLeftFrontCargoAutoMode().placeHatch(), takeHatch(), placeHatch2(),
				takeCargo(), placeCargoClose());
	}
	...
	public Routine takeHatch() { // cargo ship front to loading station
		...
		BackCargoShipToLoadingStation.add(new Waypoint(
				new Translation2d(
						kCargoShipLeftFront.translateBy(new Translation2d(0, PhysicalConstants.kRobotLengthInches))),
				kRunSpeed)); // backs out of the cargo ship
		BackCargoShipToLoadingStation.add(new Waypoint(
				new Translation2d((kCargoShipLeftFrontX * .5 + kOffsetX), kLeftLoadingStationY * .5 + kOffsetY),
				kRunSpeed));
		BackCargoShipToLoadingStation
				.add(new Waypoint(new Translation2d(kHabLineX + PhysicalConstants.kRobotLengthInches * 2 + kOffsetX,
		...
		ForwardCargoShipToLoadingStation
				.add(new Waypoint(new Translation2d(kHabLineX + kOffsetX, kLeftLoadingStationY + kOffsetY), kRunSpeed));
	...
	public Routine placeHatch2() { // loading station to rocket ship close
		 ...
		 * then goes around the rocket ship over and shoots it a bit. Then, it lines up
	...
	public Routine placeCargoClose() { // depot to close rocket ship - shoot cargo into the far rocket ship
		...
		/*
		 * The robot starts at the depot after loading a cargo. It then goes to rocket
		 * ship close and shoots a cargo into rocket ship far.
		 */
