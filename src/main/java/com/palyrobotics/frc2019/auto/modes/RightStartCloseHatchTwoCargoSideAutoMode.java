...
public class RightStartCloseHatchTwoCargoSideAutoMode extends AutoModeBase {
	...
	public Routine getRoutine() {
		return new SequentialRoutine(new RightStartRightFrontCargoAutoMode().placeHatch(), CargoShipToDepot(),
	...
	public Routine CargoShipToDepot() { // cargo ship to depot
		...
		CargoShipToDepot
				.add(new Waypoint(new Translation2d(kHabLineX + PhysicalConstants.kRobotLengthInches * 1.05 + kOffsetX,
						kRightDepotY + PhysicalConstants.kRobotLengthInches * .25 + kOffsetY), SPEED)); // line up with
																										// depot
		CargoShipToDepot.add(new Waypoint(new Translation2d(
				kRightDepotX + PhysicalConstants.kRobotLengthInches * 1.1 + kOffsetX, kRightDepotY + kOffsetY), 0));
		// move elevator down
	...
	public Routine placeCargo(int CargoSlot) { // depot to cargo ship bays
		...
		DepotToCargoShip
				.add(new Waypoint(new Translation2d(kRightFirstCargoShipX + PhysicalConstants.kRobotLengthInches * .55
						+ CargoSlot * PhysicalConstants.kCargoLineGap + kOffsetX, kRightDepotY + kOffsetY), SPEED));
		DepotToCargoShip.add(new Waypoint(new Translation2d(
				kRightFirstCargoShipX + PhysicalConstants.kRobotLengthInches * .85
						+ CargoSlot * PhysicalConstants.kCargoLineGap + kOffsetX,
				kRightFirstCargoShipY - PhysicalConstants.kRobotLengthInches + kOffsetY), SPEED)); // line up in front
																									// of cargo bay
		DepotToCargoShip.add(new Waypoint(new Translation2d(
				kRightFirstCargoShipX + PhysicalConstants.kRobotLengthInches * .85
						+ CargoSlot * PhysicalConstants.kCargoLineGap + kOffsetX,
	...
	public Routine takeCargo(int DepotSlot) { // cargo ship bays to depot
		...
		CargoShipToDepot.add(new Waypoint(new Translation2d(
				kRightFirstCargoShipX + DepotSlot * PhysicalConstants.kCargoLineGap
						+ PhysicalConstants.kRobotLengthInches + kOffsetX,
				kRightFirstCargoShipY - PhysicalConstants.kRobotLengthInches * .7 + kOffsetY), SPEED));
		CargoShipToDepot
				.add(new Waypoint(new Translation2d(kRightFirstCargoShipX + DepotSlot * PhysicalConstants.kCargoLineGap
						+ PhysicalConstants.kRobotLengthInches + kOffsetX, kRightDepotY + kOffsetY), SPEED)); // turn
																												// back
																												// and
																												// line
																												// up
		...
		CargoShipToDepot
				.add(new Waypoint(new Translation2d(kRightFirstCargoShipX + DepotSlot * PhysicalConstants.kCargoLineGap
						- PhysicalConstants.kRobotLengthInches * .5 + kOffsetX, kRightDepotY + kOffsetY), SPEED));
		CargoShipToDepot.add(new Waypoint(new Translation2d(kHabLineX + kOffsetX, kRightDepotY + kOffsetY), SPEED));
		CargoShipToDepot.add(new Waypoint(new Translation2d(
				kRightDepotX + PhysicalConstants.kRobotLengthInches - (DepotSlot + 1) * kCargoDiameter + kOffsetX,
