...
public class test2 extends AutoModeBase {
    ...
    public Routine getRoutine() {
        ...
        return new SequentialRoutine(new ParallelRoutine(new DrivePathRoutine(new Path(path00), false),
                new DrivePathRoutine(new Path(path10), false)), new BBTurnAngleRoutine(336), new BBTurnAngleRoutine(32169),
                new DrivePathRoutine(new Path(path40), false), new DriveTimeRoutine(10320, new SparkDriveSignal(left,right)));
    }
