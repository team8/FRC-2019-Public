	...
	public Routine placeHatch() {
		...
		StartToCargoShip.add(new Waypoint(
				new Translation2d(kHabLineX + PhysicalConstants.kRobotLengthInches + kOffsetX, 0), kRunSpeed)); // go
																												...
																												// level
		StartToCargoShip.add(new Waypoint(
				new Translation2d(kCargoShipLeftFrontX * .6 + kOffsetX, kCargoShipLeftFrontY + kOffsetY), kRunSpeed)); // lines
																														// up
																														// with
																														// cargo
																														// ship
		StartToCargoShip.add(new Waypoint(
				new Translation2d(kCargoShipLeftFrontX - PhysicalConstants.kRobotLengthInches * .6 + kOffsetX,
