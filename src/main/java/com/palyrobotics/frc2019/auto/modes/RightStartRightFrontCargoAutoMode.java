...
public class RightStartRightFrontCargoAutoMode extends AutoModeBase {
	...
	public Routine placeHatch() {
		...
		StartToCargoShip
				.add(new Waypoint(new Translation2d(kHabLineX + PhysicalConstants.kRobotLengthInches * 0.1 + kOffsetX,
		...
		StartToCargoShip.add(new Waypoint(
				new Translation2d((kCargoShipRightFrontX - PhysicalConstants.kRobotLengthInches * 0.7) * .85 + kOffsetX,
						kCargoShipRightFrontY + PhysicalConstants.kRobotLengthInches * 0.35 + kOffsetY),
				kRunSpeed, "visionStart"));
		StartToCargoShip.add(new Waypoint(
				new Translation2d(kCargoShipRightFrontX - PhysicalConstants.kRobotLengthInches * 0.7 + kOffsetX,
						kCargoShipRightFrontY + PhysicalConstants.kRobotLengthInches * 0.35 + kOffsetY),
				0));
