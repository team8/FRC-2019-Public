...
import com.palyrobotics.frc2018.auto.modes.RightStartRightFrontCargoShip;
...
public class RightStartFrontCargoDepotFirstCargo extends AutoModeBase { //starts at center (lvl 3) - robot will probably start on lvl 2
    ...
    public Routine getRoutine() {
        return new SequentialRoutine(new ParallelRoutine(new DriveSensorResetRoutine(2), new IntakeUpRoutine()), placeHatch1(), takeCargo(), placeCargo());
    }
