...
public class RightStartThreeCargoAutoMode extends AutoModeBase {
	...
	public Routine placeCargoStart() { // start to cargo ship front
		...
		StartToCargoShip.add(new Waypoint(new Translation2d(kHabLineX + kOffsetX, 0), kRunSpeed * .5));
		StartToCargoShip.add(new Waypoint(new Translation2d(kRightRocketShipMidX + kOffsetX, 0), 0));
		...
		routines.add(
				new ParallelRoutine(new DrivePathRoutine(new Path(goBackABit), true), new IntakeBeginCycleRoutine()));
	...
	public Routine placeCargo(int CargoSlot) {
		...
		StartToCargoShip.add(new Waypoint(
				new Translation2d(kHabLineX + PhysicalConstants.kRobotLengthInches + kOffsetX, 0), kRunSpeed * .5));
		StartToCargoShip.add(new Waypoint(new Translation2d(
				kRightFirstCargoShipX + CargoSlot * PhysicalConstants.kCargoLineGap
						- PhysicalConstants.kRobotLengthInches * 2 + kOffsetX,
				kRightFirstCargoShipY - PhysicalConstants.kRobotLengthInches + kOffsetY), kRunSpeed));
		StartToCargoShip
				.add(new Waypoint(
						new Translation2d(
								kRightFirstCargoShipX + CargoSlot * PhysicalConstants.kCargoLineGap
										- PhysicalConstants.kRobotLengthInches * .5 + kOffsetX,
	...
	public Routine takeCargo(int DepotSlot) {
		...
		CargoShipToDepot
				.add(new Waypoint(new Translation2d(kHabLineX + PhysicalConstants.kRobotLengthInches * 1 + kOffsetX,
						kRightDepotY + PhysicalConstants.kRobotLengthInches * .25 + kOffsetY), kRunSpeed));
		CargoShipToDepot.add(new Waypoint(new Translation2d(
				kRightDepotX + DepotSlot * kCargoDiameter + PhysicalConstants.kRobotLengthInches * 1.1 + kOffsetX,
