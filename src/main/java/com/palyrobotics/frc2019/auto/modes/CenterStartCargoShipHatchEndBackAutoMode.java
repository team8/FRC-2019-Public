...
public class CenterStartCargoShipHatchEndBackAutoMode extends AutoModeBase { //starts at center (lvl 3) - robot will probably start on lvl 2
...
//    public static double kHabLineX = 95.28;
    ...
    public Routine takeHatch() {
        ...
        backCargoShipToLoadingStation.add(new Waypoint(new Translation2d(kLSX, kLSY), 0));
