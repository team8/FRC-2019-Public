...
public class TwoBall extends AutoModeBase {
	...
	public Translation2d kRightLoadingStation = new Translation2d(
			kRightLoadingStationX + PhysicalConstants.kRobotLengthInches * 0.5 + kOffsetX,
	...
	public Translation2d kRightRocketShipClose = new Translation2d(
			kRightRocketShipCloseX - PhysicalConstants.kRobotLengthInches * 0 + kOffsetX,
	...
	public Routine placeHatchClose1() { // start to rocket ship close
		...
		StartToRocketShip.add(new Waypoint(
				new Translation2d(kHabLineX + PhysicalConstants.kRobotLengthInches * 0.5 + kOffsetX, 0), kRunSpeed)); // goes
																														// straight
																														// at
																														// the
																														// start
		...
		StartToRocketShip.add(new Waypoint(new Translation2d(kRightRocketShipCloseX * .6 + kOffsetX,
				findLineClose(kRightRocketShipCloseX * .8) + PhysicalConstants.kRobotLengthInches * .35 + kOffsetY),
				kRunSpeed, "visionStart")); // line up with rocket ship
