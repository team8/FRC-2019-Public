...
//// Logger.getInstance().logRobotThread(Level.WARNING, "AutoModeSelector does
// not contain auto mode", name);
// return null;
// }
// int index = mAutoMap.get(name);
//// Logger.getInstance().logRobotThread(Level.INFO, "Setting auto mode by
// name", name);
...
// index = 0;
// }
//// Logger.getInstance().logRobotThread(Level.INFO, "Selected AutoMode by
// index", mAutoModes.get(index));
// return mAutoModes.get(index);
// }
// }
//
