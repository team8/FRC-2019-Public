...
// }
//
// public Segment(double pos, double vel, double acc, double jerk, double
// heading, double dt, double x, double y) {
// this.pos = pos;
// this.vel = vel;
// this.acc = acc;
// this.jerk = jerk;
...
// segment.y *= -1.0;
// segment.heading = MathUtil.boundAngle0to2PiRadians(2 * Math.PI -
// segment.heading);
// return segment;
// }
// } else {
...
// StringBuilder("Segment\tPos\tVel\tAcc\tJerk\tHeading\n");
// for (int i = 0; i < getNumSegments(); ++i) {
