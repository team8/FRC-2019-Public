...
// * Double Click Timer
// *
// * @author Ailyn Tong Differentiates between a single and double click. A
// tolerance window ensures a double click isn't registered immediately after a
// single
// * click due to fast update times. A WaitTimer ensures a double click can be
// acted upon and not immediately overridden by a single click.
// *
...
// */
// public DoubleClickTimer(double minTolerance, double maxTolerance, double
// waitTime) {
// kMinTolerance = minTolerance;
// kMaxTolerance = maxTolerance;
// kWaitTime = waitTime;
...
// /*
// * If a double click has already been registered, wait timer will override
// double click timer
// */
// if(twice) {
// if(wait.timeout()) {
