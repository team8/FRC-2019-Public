...
//
/// **
// * Drives forward a specified distance Uses right encoder to determine if
// distance is reached Times out after specified seconds, default
// m_default_timeout
// *
// * @author Nihar
// */
...
//
// /*
// * START = Set new drive set point DRIVING = Waiting to reach drive set point
...
//
// /**
// * Constructs with target distance Uses default timeout and default velocity
// set point
// *
...
// manager then moves the physical
// //subsystems based on.
// @Override
