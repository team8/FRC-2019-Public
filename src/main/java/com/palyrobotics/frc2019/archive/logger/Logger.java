...
//
/// **E
// * Log is at /home/lvuser/logs/ directory Unit test safe, creates diff file
// directory for Mac/Windows/Linux fileName defaults to ex: "Mar13 13-29" using
// * 24-hr-time Can set desired filename manually If log file exists on first
// start, automatically creates new file
// *
// * If run on roboRIO, will attempt to copy the driverstation console log to
// this directory to save it No longer uses bufferedwriter, uses Guava Files to
// append
// * to file
// *
// * FYI, buffered writer closes the underlying filewriter and flushes the
// buffer
// */
// public class Logger {
...
//
// /**
// * Creates the file at desired filepath, avoids file collision, will not
// recreate if logger already there Also sanitizes inputs to prevent unwanted
// * directory creation
// */
// public void start() {
// if(fileName == "DEFAULT") {
...
// }
// String cDate =
// ZonedDateTime.now(LoggerConstants.tZone).format(DateTimeFormatter.ofPattern("MM-dd-yy"));
// String cTime =
// ZonedDateTime.now(LoggerConstants.tZone).format(DateTimeFormatter.ofPattern("HH-mm"));
// String os = System.getProperty("os.name");
// String filePath = fileName + File.separatorChar + cDate + File.separatorChar
// + fileName + "-" + cTime;
...
// try {
// mSubsystemThreadLogs.add(new LeveledString(l, checkStackTrace(l,
// v.orElse("NULL VALUE"))));
...
// try {
// mSubsystemThreadLogs.add(new LeveledString(l, k.orElse("NULL KEY"),
// checkStackTrace(l, v.orElse("NULL VALUE"))));
// } catch(ConcurrentModificationException e) {
// System.err.println("Attempted concurrent modification on subsystem logger");
// }
// }
...
// Optional<Object> v = Optional.ofNullable(value);
// try {
// mRobotThreadLogs.add(new LeveledString(l, checkStackTrace(l, v.orElse("NULL
// VALUE"))));
// } catch(ConcurrentModificationException e) {
...
// Optional<String> k = Optional.ofNullable(key);
// try {
// mRobotThreadLogs.add(new LeveledString(l, k.orElse("NULL KEY"),
// checkStackTrace(l, v.orElse("NULL VALUE"))));
// } catch(ConcurrentModificationException e) {
// System.err.println("Attempted concurrent modification on robot logger");
// }
...
// l.intValue() <= LoggerConstants.traceLevel.intValue()) {
...
//
// /**
// * Writes current log messages to file and console according to level Still
// supports deprecated log messages, will log all of them
// */
...
// Files.append(((LeveledString) c).getLeveledString(), mainLog,
// Charsets.UTF_8);
// if(((LeveledString) c).getLevel().intValue() >=
// LoggerConstants.displayLevel.intValue() && writeLimit <=
// LoggerConstants.writeLimit) {
// writeLimit++;
// }
// }
// } catch(IOException e) {
