...
//
/// **
// * Created by Nihar on 3/13/17. Stores a String with the timestamp on
// construction Allows data structures to sort the strings by timestamp And then
// retrieve the
// * String Also automatically adds a newline to the end
// *
// * Updated by Joseph 10/24/2017 Replaced system time with zonedTime using
// external time zone constant Still stored as UTC
// */
...
// return
// (mTime.withZoneSameInstant(LoggerConstants.tZone).format(DateTimeFormatter.ISO_LOCAL_TIME))
// + (mKey==null ? "" : ": " + mKey )+ ": " + mString + "\n";
// }
//
// @Override
