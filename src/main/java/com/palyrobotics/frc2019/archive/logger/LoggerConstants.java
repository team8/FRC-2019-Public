...
// * Created on 10/27/17
// *
// * @author Joseph Rumelhart Replaces constant file for logger constants Avoids
// interference with other code, can be changed easily to account for time zone
// * changes
// */
// public class LoggerConstants {
// /**
// * Explanation of logger levels: <p>
// * SEVERE: Errors which will cause a major part of the program to stop working
// (1000) <p>
// * WARNING: Errors which will cause a minorfailure or indicate a risk of
// serious failure (900) <p>
// * INFO: Information on the normal functioning of the robot; Expect this level
// and above to be printed to console (800) <p>
...
// * ALL: Not actually a level, used to display information from all levels
// (Integer.MIN_VALUE)
// */
