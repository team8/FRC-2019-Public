...
public class Kinematics {
	...
	public static RigidTransform2d.Delta forwardKinematics(double leftWheelDelta, double rightWheelDelta) {
		...
		double rotationDelta = velocityDelta * 2 * DrivetrainConstants.kTrackScrubFactor
				/ DrivetrainConstants.kTrackEffectiveDiameter;
	...
	public static DriveVelocity inverseKinematics(RigidTransform2d.Delta velocity) {
		...
		double velocityDelta = DrivetrainConstants.kTrackEffectiveDiameter * velocity.dTheta
				/ (2 * DrivetrainConstants.kTrackScrubFactor);
