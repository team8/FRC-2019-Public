...
public class Gains {
	...
	public static final Gains vidarDriveDistance = new Gains(kVidarDriveDistanceP, kVidarDriveDistanceI,
			kVidarDriveDistanceD, 0, kVidarDriveDistanceIZone);
	...
	public static final Gains vidarShortDriveMotionMagicGains = new Gains(kVidarShortDriveMotionMagicP,
			kVidarShortDriveMotionMagicI, kVidarShortDriveMotionMagicD, kVidarShortDriveMotionMagicF,
			kVidarShortDriveMotionMagicIZone);
	...
	public static final Gains vidarTurnMotionMagicGains = new Gains(kVidarTurnMotionMagickP, kVidarTurnMotionMagickI,
			kVidarTurnMotionMagickD, kVidarTurnMotionMagickF, kVidarTurnMotionMagickIzone);

	private static final double kVidarElevatorPositionP = 0.5, // 0.7;
			kVidarElevatorPositionI = 0.0, kVidarElevatorPositionD = 3.4, // 2.0;
			kVidarElevatorPositionF = 0.0, kVidarElevatorPositionIZone = 0.0;
	public static final Gains elevatorPosition = new Gains(kVidarElevatorPositionP, kVidarElevatorPositionI,
			kVidarElevatorPositionD, kVidarElevatorPositionF, kVidarElevatorPositionIZone);
