...
/**
 * Created by Nihar on 1/14/17. Mocks the output of a CANTalon's configuration
 * Allows passthrough of -1 to 1 mSignal Allows configuration for offboard SRX
 * calculations
 *
 * @author Nihar
 */
public class TalonSRXOutput {
	...
	// Velocity, Position, MotionMagic, PercentOutput, Current, Disabled,
	// MotionProfile
	...
	public boolean equals(Object other) {
		...
		return Double.compare(otherTalon.setPoint, setPoint) == 0
				&& Double.compare(otherTalon.arbitraryDemand, arbitraryDemand) == 0 && profile == otherTalon.profile
				&& acceleration == otherTalon.acceleration && cruiseVelocity == otherTalon.cruiseVelocity
				&& controlMode == otherTalon.controlMode && gains.equals(otherTalon.gains);
	}
