...
public class Pose {
	...
	@Override // Auto-generated
	public int hashCode() {
		return Objects.hash(heading, lastHeading, headingVelocity, leftEncoderPosition, lastLeftEncoderPosition,
				leftEncoderVelocity, lastRightEncoderPosition, rightEncoderPosition, rightEncoderVelocity);
	}

	@Override // Auto-generated
	public String toString() {
		return String.format(
				"Pose{heading=%s, lastHeading=%s, headingVelocity=%s, leftEncoderPosition=%s, lastLeftEncoderPosition=%s, leftEncoderVelocity=%s, lastRightEncoderPosition=%s, rightEncoderPosition=%s, rightEncoderVelocity=%s}",
				heading, lastHeading, headingVelocity, leftEncoderPosition, lastLeftEncoderPosition,
				leftEncoderVelocity, lastRightEncoderPosition, rightEncoderPosition, rightEncoderVelocity);
	}
}