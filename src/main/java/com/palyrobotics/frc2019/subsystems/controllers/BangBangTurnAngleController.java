...
public class BangBangTurnAngleController implements Drive.DriveController {
	...
	public BangBangTurnAngleController(Pose currentPose, double heading) {
		...
		// Logger.getInstance().logSubsystemThread(Level.INFO, "Starting Heading",
		// this.mCachedPose.heading);
		// Logger.getInstance().logSubsystemThread(Level.INFO, "Target Heading",
		// this.mTargetHeading);
