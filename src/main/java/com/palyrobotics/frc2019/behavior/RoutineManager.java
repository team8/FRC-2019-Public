...
public class RoutineManager {
	...
	private ArrayList<Routine> mRunningRoutines = new ArrayList<>(), mRoutinesToRemove = new ArrayList<>(),
	...
	/**
	 * Updates the commands that are passed in based on the running and canceled
	 * routines
	 *
	...
	public Commands update(Commands commands) {
		...
		// Add newest routines after current routines may have finished, start them, and
		// update them
		...
		// Intentionally runs even if cancelCurrentRoutines is true, as these are new
		// routines requested on the same cycle.
