...
public class DrivetrainConstants {
	 ...
	 */
	// Distance between the intermediate points inserted in the drive path; set to 0
	// to turn off insertion
	...
	public static final double kSmoothingTolerance = 0.001; // When the change in path falls below the threshold it is
															// basically converged
	public static final double kSmoothingMaxIters = 10000;
	public static final double kTurnVelocityReduction = 2; // A constant for reducing following speed during turns; 1
															// for slowest turning, 5 for fastest
	...
	public static final double kVisionTargetThreshold = 5; // threshold before target cannot be seen
	/**
	 * Tolerances
	 */
	 ...
	 * Unit Conversions
	 */
	public static final double kDriveInchesPerRotation = kDriveWheelDiameterInches * Math.PI * (12.0 / 46.0)
			* (22.0 / 44.0);
	...
	// (1-alpha) is how much the QuickStopAccumulator is affected by the previous
	...
	public String toString() {
		return String.format(
				"kQuickStopAccumulatorDecreaseRate %skQuickStopAccumulatorDecreaseThreshold %skNegativeInertiaScalar %skAlpha %skDriveInchesPerRotation %skDriveInchesPerDegree%skDriveSpeedUnitConversion %s",
				kQuickStopAccumulatorDecreaseRate, kQuickStopAccumulatorDecreaseThreshold, kNegativeInertiaScalar,
