...
public class ElevatorConfig extends AbstractSubsystemConfig {
	...
	public double manualPowerMultiplier, elevatorHeight1, elevatorHatchHeight2, elevatorCargoHeight2, elevatorHeight3,
			secondStageCanStartMovingArm, acceptablePositionError, acceptableVelocityError, closedLoopZoneHeight,
			outOfClosedLoopZoneIdleDelayMs, feedForward;
