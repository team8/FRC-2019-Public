...
public class IntakeConfig extends AbstractSubsystemConfig {
	...
	/* Intake Config */
	public double motorVelocity, fastIntakeVelocity, droppingVelocity, expellingVelocity, verySlowly, medium;

	public double maxAngle, // 90 - 61.7 + 90
			potentiometerMaxAngleTicks;

	/* Feed Forward */
	public double gravityFF, accelerationCompensation, centripetalCoefficient, angleOffset; // Offset for center of mass

	/* Set Points */
	public double intakeAngle, // Degrees relatively to the plane of the field.
	...
	public double acceptableAngularError, angularVelocityError, cargoInchTolerance;
	public int cargoCountRequired;
	...
	public static final double kArmPotentiometerTicksPerDegree = (4.5 / 1.0) * ((1.0 / 5.0) / 360.0),
			kArmDegreesPerRevolution = (360.0) / ((68.0 / 14.0) * (38.0 / 18.0) * (36.0 / 14.0) * (54.0 / 12.0)), // rev
																													// →
																													// deg
