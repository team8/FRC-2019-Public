...
public class RobotState {
	...
	public double cargoDistance, intakeStartAngle, // Angle in degrees
			intakeAngle, // Angle in degrees
			intakeAppliedOutput, intakeVelocity; // RPM
	public CircularBuffer leftIntakeReadings = new CircularBuffer(kUltrasonicBufferSize),
	...
	public RigidTransform2d getPredictedFieldToVehicle(double lookAheadTime) {
		return getLatestFieldToVehicle().getValue().transformBy(
				RigidTransform2d.fromVelocity(new RigidTransform2d.Delta(vehicleVelocity.dX * lookAheadTime,
						vehicleVelocity.dY * lookAheadTime, vehicleVelocity.dTheta * lookAheadTime)));
	}
	...
	public RigidTransform2d generateOdometryFromSensors(double leftEncoderDelta, double rightEncoderDelta,
