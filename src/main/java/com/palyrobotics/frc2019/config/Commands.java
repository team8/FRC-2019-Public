...
/**
 * Commands represent the desired set points and subsystem states for the robot.
 * <br />
 * Store Requests (enum) for each subsystem and set points {@link SetPoints}
 * <br />
...
public class Commands {
	...
	public void addWantedRoutine(Routine wantedRoutine) {
		for (Routine routine : wantedRoutines) {
			if (routine.getClass().equals(wantedRoutine.getClass())) {
				// Logger.getInstance().logRobotThread(Level.WARNING, "tried to add duplicate
	...
	public static class SetPoints {
		...
		public Double elevatorPositionSetPoint, pusherPositionSetPoint, intakePositionSetPoint;
	}
